	...
	let data = {
		...
		text: (
			<div>
				...
				<p>Azza's integrated methodology combines the structured, multisensory strength of Orton-Gillingham with the analytical depth of Structured Word Inquiry. This scientific, factual approach demystifies the English writing system, turning struggling readers into informed and confident learners.</p>
