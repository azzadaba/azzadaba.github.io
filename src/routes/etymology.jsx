    ...
    text: (
      <div>
        <p>
          ...
          <br /><br />
          It helps students understand the connections between words that share a base element and sheds light on how words have been shaped by human communication over.</p>
      </div>
    )
  }
